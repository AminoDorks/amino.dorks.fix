...
class UserProfile:
    def __init__(self, data):
        ...
        self.api_key: str = None # pyright: ignore[reportAttributeAccessIssue] # stub
    ...
    def UserProfile(self):
        ...
        try:
            ...
            pass
        try:
            self.backgroundImage = self.json["extensions"]["style"]["backgroundMediaList"][1]
...
class UserProfileList:
    ...
    def UserProfileList(self):
        for x in self.json:
            ...
            try:
                self.backgroundImage.append(x["extensions"]["style"]["backgroundMediaList"][1])
            except (KeyError, TypeError, IndexError):
            ...
            try:
                self.notificationSubscriptionStatus.append(x["notificationSubscriptionStatus"])
            except (KeyError, TypeError):
            ...
            try:
                self.privilegeOfChatInviteRequest.append(x["extensions"]["privilegeOfChatInviteRequest"])
            except (KeyError, TypeError):
                self.privilegeOfChatInviteRequest.append(None)
            try:
                self.privilegeOfCommentOnUserProfile.append(x["extensions"]["privilegeOfCommentOnUserProfile"])
            except (KeyError, TypeError):
...
class BlogList:
    def __init__(self, data, nextPageToken = None, prevPageToken = None):
        ...
        for y in data:
            try:
                ...
                _author.append(None)
            try:
                _quizQuestionList.append(QuizQuestionList(y["quizQuestionList"]).QuizQuestionList)
            except (KeyError, TypeError):
    ...
    def BlogList(self):
        for x in self.json:
            ...
            try:
                self.quizTotalQuestionCount.append(x["extensions"]["quizTotalQuestionCount"])
            except (KeyError, TypeError):
            ...
            try:
                self.quizLastAddQuestionTime.append(x["extensions"]["quizLastAddQuestionTime"])
            except (KeyError, TypeError):
...
class Blog:
    def __init__(self, data):
        ...
        try:
            self.quizQuestionList: QuizQuestionList = QuizQuestionList(data["quizQuestionList"]).QuizQuestionList
        except (KeyError, TypeError):
    ...
    def Blog(self):
        ...
        try:
            ...
            pass
        try:
            self.quizTotalQuestionCount = self.json["extensions"]["quizTotalQuestionCount"]
        except (KeyError, TypeError):
            pass
        try:
            ...
            pass
        try:
            self.quizLastAddQuestionTime = self.json["extensions"]["quizLastAddQuestionTime"]
        except (KeyError, TypeError):
            pass
        try:
    ...
    def __init__(self, data):
        ...
        try:
            self.author: UserProfile = UserProfile(data["author"]).UserProfile
                ...
                self.author: UserProfile = UserProfile([])
        try:
            self.labels: WikiLabelList = WikiLabelList(data["extensions"]["props"]).WikiLabelList
        except (KeyError, TypeError):
...
class WikiList:
    ...
    def WikiList(self):
        for x in self.json:
            ...
            try:
                self.originalWikiId.append(x["extensions"]["knowledgeBase"]["originalItemId"])
            except (KeyError, TypeError):
                self.originalWikiId.append(None)
            try:
                self.contributors.append(x["extensions"]["knowledgeBase"]["contributors"])
            except (KeyError, TypeError):
...
class Community:
    def __init__(self, data):
        ...
        try:
            self.rankingTable: RankingTableList = RankingTableList(data["advancedSettings"]["rankingTable"]).RankingTableList
        except (KeyError, TypeError):
...
class CommunityList:
    def __init__(self, data):
        ...
        for y in data:
            try:
                ...
                _agent.append(None)
            try:
                _rankingTable.append(RankingTableList(y["advancedSettings"]["rankingTable"]).RankingTableList)
            except (KeyError, TypeError):
    ...
    def CommunityList(self):
        for x in self.json:
            ...
            try:
                self.isStandaloneAppMonetizationEnabled.append(x["isStandaloneAppMonetizationEnabled"])
            except (KeyError, TypeError):
            ...
            try:
                self.defaultRankingTypeInLeaderboard.append(x["advancedSettings"]["defaultRankingTypeInLeaderboard"])
            except (KeyError, TypeError):
            ...
            try:
                self.hasPendingReviewRequest.append(x["advancedSettings"]["hasPendingReviewRequest"])
            except (KeyError, TypeError):
                self.hasPendingReviewRequest.append(None)
            try:
                self.welcomeMessageEnabled.append(x["advancedSettings"]["welcomeMessageEnabled"])
            except (KeyError, TypeError):
            ...
            try:
                self.pollMinFullBarVoteCount.append(x["advancedSettings"]["pollMinFullBarVoteCount"])
            except (KeyError, TypeError):
            ...
            try:
                self.facebookAppIdList.append(x["advancedSettings"]["facebookAppIdList"])
            except (KeyError, TypeError):
            ...
            try:
                self.joinedBaselineCollectionIdList.append(x["advancedSettings"]["joinedBaselineCollectionIdList"])
            except (KeyError, TypeError):
            ...
            try:
                self.themeHomePageAppearance.append(x["configuration"]["appearance"]["homePage"]["navigation"])
            except (KeyError, TypeError):
                self.themeHomePageAppearance.append(None)
            try:
                self.themeLeftSidePanelTop.append(x["configuration"]["appearance"]["leftSidePanel"]["navigation"]["level1"])
            except (KeyError, TypeError):
                self.themeLeftSidePanelTop.append(None)
            try:
                self.themeLeftSidePanelBottom.append(x["configuration"]["appearance"]["leftSidePanel"]["navigation"]["level2"])
            except (KeyError, TypeError):
                self.themeLeftSidePanelBottom.append(None)
            try:
                self.themeLeftSidePanelColor.append(x["configuration"]["appearance"]["leftSidePanel"]["style"]["iconColor"])
            except (KeyError, TypeError):
...
class FromCode:
    def __init__(self, data):
        ...
        try:
            self.community: Community = Community(data["extensions"]["community"]).Community
        except (KeyError, TypeError):
...
class UserProfileCountList:
    def __init__(self, data):
        ...
        try:
            self.profile: UserProfileList = UserProfileList(data["userProfileList"]).UserProfileList
        except (KeyError, TypeError):
    ...
    def __init__(self, data):
        ...
        try:
            self.author = UserProfile(data["itemCategory"]["author"]).UserProfile
                ...
                self.author: UserProfile = UserProfile([])
        try:
            self.subCategory = WikiCategoryList(data["childrenWrapper"]["itemCategoryList"]).WikiCategoryList
        except (KeyError, TypeError):
...
class Thread:
    def __init__(self, data):
        ...
        try:
            self.author: UserProfile = UserProfile(data["author"]).UserProfile
                ...
                self.author: UserProfile = UserProfile([])
        try:
            self.membersSummary: UserProfileList = UserProfileList(data["membersSummary"]).UserProfileList
        except (KeyError, TypeError):
    ...
    def Thread(self):
        ...
        try:
            ...
            pass
        try:
            self.organizerTransferCreatedTime = self.json["extensions"]["organizerTransferRequest"]["createdTime"]
        except (KeyError, TypeError):
            pass
        try:
            self.organizerTransferId = self.json["extensions"]["organizerTransferRequest"]["requestId"]
        except (KeyError, TypeError):
            pass
...
class ThreadList:
    def __init__(self, data):
        ...
        for y in data:
            ...
            try:
                _membersSummary.append(UserProfileList(y["membersSummary"]).UserProfileList)
            except (KeyError, TypeError):
    ...
    def ThreadList(self):
        for chat in self.json:
            ...
            try:
                ...
                self.backgroundImage.append(None)
            try:
                self.lastMembersSummaryUpdateTime.append(chat["extensions"]["lastMembersSummaryUpdateTime"])
            except (KeyError, TypeError):
            ...
            try:
                self.screeningRoomHostId.append(chat["extensions"]["screeningRoomHostUid"])
            except (KeyError, TypeError):
            ...
            try:
                ...
                self.disabledTime.append(None)
            try:
                self.screeningRoomPermission.append(chat["extensions"]["screeningRoomPermission"]["action"])
            except (KeyError, TypeError):
                self.screeningRoomPermission.append(None)
            try:
                self.organizerTransferCreatedTime.append(chat["extensions"]["organizerTransferRequest"]["createdTime"])
            except (KeyError, TypeError):
                self.organizerTransferCreatedTime.append(None)
            try:
                self.organizerTransferId.append(chat["extensions"]["organizerTransferRequest"]["requestId"])
            except (KeyError, TypeError):
...
class Sticker:
    def __init__(self, data):
        ...
        try:
            self.collection: StickerCollection = StickerCollection(data["stickerCollectionSummary"]).StickerCollection
        except (KeyError, TypeError):
    ...
    def __init__(self, data):
        ...
        try:
            self.author: UserProfile = UserProfile(data["author"]).UserProfile
                ...
                self.author: UserProfile = UserProfile([])
        try:
            self.originalAuthor: UserProfile = UserProfile(data["extensions"]["originalAuthor"]).UserProfile
        except (KeyError, TypeError):
                self.originalAuthor: UserProfile = UserProfile([])
        try:
            self.originalCommunity: Community = Community(data["extensions"]["originalCommunity"]).Community
        except (KeyError, TypeError):
...
class Message:
    ...
    def Message(self):
        ...
        try:
            ...
            pass
        try:
            self.videoCoverImage = self.json["extensions"]["videoExtensions"]["coverImage"]
        except (KeyError, TypeError):
            pass
        try:
        ...
        try:
            self.mentionUserIds = [m["uid"] for m in self.json["extensions"]["mentionedArray"]]
        except (KeyError, TypeError):
            pass
        try:
...
class MessageList:
    ...
    def MessageList(self):
        for x in self.json:
            ...
            try:
                self.mentionUserIds.append([m["uid"] for m in x["extensions"]["mentionedArray"]])
            except (KeyError, TypeError):
...
class CommunityStickerCollection:
    def __init__(self, data):
        ...
        try:
            self.sticker: StickerCollectionList = StickerCollectionList(data["stickerCollectionList"]).StickerCollectionList
        except (KeyError, TypeError):
...
class InfluencerFans:
    def __init__(self, data):
        ...
        try:
            self.influencerProfile: UserProfile = UserProfile(data["influencerUserProfile"]).UserProfile
        except (KeyError, TypeError):
...
class QuizQuestionList:
    def __init__(self, data):
        ...
        for y in data:
            try:
                _answersList.append(QuizAnswers(y["extensions"]["quizQuestionOptList"]).QuizAnswers)
            except (KeyError, TypeError):
    ...
    def QuizQuestionList(self):
        for x in self.json:
            ...
            try:
                ...
                self.style.append(None)
            try:
                self.backgroundImage.append(x["extensions"]["style"]["backgroundMediaList"][0][1])
            except (KeyError, TypeError, IndexError):
                self.backgroundImage.append(None)
            try:
                self.backgroundColor.append(x["extensions"]["style"]["backgroundColor"])
...
class QuizRankings:
    ...
    def QuizRankings(self):
        ...
        try:
            ...
            pass
        try:
            self.profile: QuizRanking = QuizRanking(self.json["quizResultOfCurrentUser"]).QuizRanking
        except (KeyError, TypeError):
            pass
...
class JoinRequest:
    ...
    def JoinRequest(self):
        try:
            self.communityMembershipRequestCount = self.json["communityMembershipRequestCount"]
        except (KeyError, TypeError):
            pass
...
class NoticeListDual:
    ...
    def NoticeList(self):
        for x in self.json:
            ...
            try:
                self.allowQuickOperation.append(x["extensions"]["config"]["allowQuickOperation"])
            except (KeyError, TypeError):
...
class LiveLayer:
    ...
    def LiveLayer(self):
        for x in self.json:
            ...
            try:
                self.userProfileList.append(UserProfileList(x["userProfileList"]).UserProfileList)
            except (KeyError, TypeError):
...
class AvatarFrameList:
    ...
    def AvatarFrameList(self):
        for x in self.json:
            ...
            try:
                self.firstMonthFreeAminoPlusMembership.append(x["additionalBenefits"]["firstMonthFreeAminoPlusMembership"])
            except (KeyError, TypeError):
